				...
				<li class="has-submenu">
					...
					<ul class="submenu">
						<?php foreach ($assign_cat as $assign): ?>
							<?php if($assign->parent == 0 && $assign->count !==0 ) : ?>
								<li class="has-submenu">
									...
									<ul class="sub-submenu">
										...
										//											?>
										<!--											<li>-->
										<!--												<a href="--><?php //the_permalink();?><!--">--><?php //the_title(); // выведем заголовок поста ?><!--</a>-->
										<!--											</li>-->
										<!--											--><?php
										//										}
										//										wp_reset_postdata();
										...
										<?php foreach ($assign_cat as $child): ?>
											...
											if($child->parent == $assign->term_id  ) :
												$term_link = get_term_link($child->term_id, $child->taxonomy);
												echo "<li><a href='". $term_link ."'>". $child->name ."</a></li>";
											endif;
											?>
										<?php endforeach; ?>
									</ul>
