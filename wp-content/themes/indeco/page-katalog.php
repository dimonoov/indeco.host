				...
				<div class="col-sm-6">
					<div class="sf-sx">
						<div class="sf-textual">
							<h2 class="sf-label">Поиск быстрого решения</h2>
						...
						<form id="solution-finder" name="formsolfinder" method="get" action="#">
							<div class="general-form-container">
								...
								<div>
									<div></div>
									<div>
										<a id="submit-button" class="call-to-action backwhite-variant disabled" style="width: 48%; padding: 10px; line-height: 23px; text-align: center;" href="#solutionfinderindustry" onclick="find_solution()">Подобрать</a>
									</div>
								</div>
							</div>
						</form>
				...
				<div class="row">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade clearfix active in" id="molot">
							...
							<div class="loading l1" style="display: none;"><img src="<?php echo get_theme_file_uri();?>/assets/http://www.mermecgroup.com/mermec-incorso/images/Image/img/loading-slider.gif" alt=""></div>
						</div>
